...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private final int mDefaultLaserColor = getResources().getColor(me.dm7.barcodescanner.core.R.color.viewfinder_laser);
    private final int mDefaultMaskColor = getResources().getColor(me.dm7.barcodescanner.core.R.color.viewfinder_mask);
    private final int mDefaultBorderColor = getResources().getColor(me.dm7.barcodescanner.core.R.color.viewfinder_border);
    private final int mDefaultBorderStrokeWidth = getResources().getInteger(me.dm7.barcodescanner.core.R.integer.viewfinder_border_width);
